...
-- Триггеры для кубов________________________________________________________________________________________________
DELIMITER $$
CREATE TRIGGER check_and_update_cubes
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER check_and_update_cubes_before_update
